  ...
  head: () => ({
    meta: [
      ...
      { title: "Token-Diet — Dynamic Context Compression for RAG" },
      {
        name: "description",
        content:
          "Token-Diet prototype: compress retrieved RAG context before the LLM to cut tokens and latency while preserving answer quality.",
      },
      { name: "author", content: "Token-Diet" },
      { property: "og:title", content: "Token-Diet — Dynamic Context Compression for RAG" },
      {
        property: "og:description",
        content: "Prototype dashboard comparing Normal RAG vs RAG + Token-Diet compression.",
      },
